...
- macOS signing and notarization are not configured yet. Users must run `xattr -cr /Applications/Peekoo.app` after installing. See [`../../docs/en/installation/macos.md`](../../docs/en/installation/macos.md) for details. Release notes include this instruction automatically.
