...
pub static ERROR_CODE_MAP: LazyLock<HashMap<&'static str, &'static str>> = LazyLock::new(|| {
    HashMap::from([
        ("-10000", "未知错误"),
        ("-10001", "服务不可用"),
        ("-10002", "参数无效"),
...
impl std::fmt::Display for MijiaError {
...
impl std::error::Error for MijiaError {}

impl From<MijiaError> for String {
    fn from(e: MijiaError) -> String {
        e.to_string()
    }
}
